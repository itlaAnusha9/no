      ...
      >
        <Card.Body style={{ padding: 0 }}>
          ...
          >
            ...
            <div>
              <Card.Title className="study-title" style={{ fontSize: '1.25rem', fontWeight: '600', margin: '0', color: '#2D5D7B' }}>
                Study Planner
              </Card.Title>
              <p className="study-subtitle" style={{ color: '#6c757d', marginBottom: '0', fontSize: '0.85rem' }}>
                Daily study plan with video resources
              </p>
            </div>
          </div>
          ...
          <div style={{ overflowX: 'auto' }}>
            <Table className="study-table" style={{ marginBottom: 0, borderCollapse: 'collapse', width: '100%' }}>
              <thead style={{ backgroundColor: '#2D5D7B', color: '#fff' }}>
                <tr>
                  {['Date', 'Subject', 'Topic', 'Video', 'Duration', 'Status'].map((heading, idx) => (
                    <th key={idx} style={{ padding: '12px 16px', fontWeight: '500', textAlign: 'left', whiteSpace: 'nowrap' }}>
                      {heading}
                    </th>
                  ))}
                </tr>
