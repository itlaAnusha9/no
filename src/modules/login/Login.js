...
//       style={{
//         backgroundImage: 'url("https://images.piclumen.com/normal/20250704/14/1a6935b59bb2494faf51a7a291b69ad2.webp")',
...
const LoginPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="modal-dialog" role="document" style={{ maxWidth: '450px', width: '90%' }}>
          <div
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="d-flex justify-content-between mt-3">
                ...
                <button
                  ...
                  className="btn btn-link p-0"
                  onClick={() => navigate('/forgot-password')}
                  style={{ color: '#9e9e9e', fontWeight: '500' }}
                >
                  Forgot password?
                </button>
              </div>
