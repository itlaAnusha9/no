...
// const courseImages = [
//   'https://img-c.udemycdn.com/course/240x135/1565838_e54e_2.jpg',
...
//   'https://img-c.udemycdn.com/course/240x135/1057360_24a1_6.jpg',
//   'https://img-c.udemycdn.com/course/240x135/1430746_8f5e_5.jpg',
...
//             Premium Courses You'll Get Access To
//           </h2>
...
//         {/* Courses Section - Mobile/Tablet Carousel */}
//         {(isMobile || isTablet) && (
//           <div className="mb-5">
...
//                       <div className={isMobile ? "col-6" : "col-md-4"} key={idx}>
//                         <div className="h-100 rounded-3 overflow-hidden" 
//                           style={{
//                             backgroundColor: '#fff',
//                             boxShadow: '0 2px 15px rgba(0,0,0,0.08)'
...
//                 }}
//               >
//                 GET ALL COURSES NOW - ₹3,600/YEAR
//               </button>
...
//               maxWidth: '600px'
//             }}>
//             <h4 className="fw-bold mb-3" style={{ color: '#2D5D7B' }}>What's Holding You Back?</h4>
//             <p className="mb-4">Join <span className="fw-bold">32,000+</span> students who transformed their careers</p>
...
//               </button>
//               <button 
//                 className="btn fw-bold py-3 px-4 border" 
//                 style={{
//                   color: '#2D5D7B',
//                   borderRadius: '8px',
//                   backgroundColor: '#fff'
