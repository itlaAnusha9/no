...
//       {/* Hero Section */}
//       <div className="row g-0 align-items-center position-relative" style={{ minHeight: 'calc(100vh - 80px)' }}>
...
//         {/* Left Section */}
//         <div className="col-lg-6 p-5 p-lg-6 position-relative" style={{ zIndex: 2 }}>
//           <motion.div
...
//             style={{
//               backgroundImage: 'url(/bestimg.png)',
