...
// // //     file: `/videos/class7/maths/chapter5.mp4`,
...
//         if (remainingCoins === 1 && !toastShown) { // Only show when last coin is being processed
//           setToastShown(true);
//           if (subtopicName) {
...
//       endX: window.innerWidth - 100, // Approximate navbar coins position
//       endY: 50, // Top of the screen where navbar is
//       value: 2, // 2 points per coin, total 10 points
//       delay: index * 100,
...
//     setToastShown(false); // Reset toast flag when new coins are created
//   };
...
//     // Check if points were already awarded for this specific video
