...
////warning msg,result in career,fullscreen
    ...
    <>
      ...
      {!selectedSubject && selectedClass && !error && (
        <div className="selection-container">
          ...
          <button className="back-button top-back" onClick={() => setSelectedClass(null)}>
            ← Back to Classes
          </button>
          <div className="cards-grid">
            {subjects.map((sub, i) => (
      ...
      {!selectedChapter && selectedSubject && !error && (
        <div className="selection-container chapter-select">
          ...
          <button className="back-button top-back" onClick={() => setSelectedSubject(null)}>
            ← Back to Subjects
          </button>
          <div className="cards-grid">
