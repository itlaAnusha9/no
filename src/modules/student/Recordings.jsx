...
//           minHeight: "100vh",
//           fontSize: "14px", // Decreased font size further
//         }}
//       >
//         <h1 style={{ textAlign: "center", color: "#111", fontSize: "1.2rem" }}>Lesson Recordings</h1>
...
//                 background: "#fff",
//                 fontSize: "14px", // Decreased font size for card
//               }}
//             >
...
const LessonRecordings = () => {
  ...
  return (
    <>
      ...
      >
        <h1
          style={{ textAlign: "center", color: "#111", fontSize: "1.2rem" }}
        >
          Lesson Recordings
        </h1>
        <p
          style={{ textAlign: "center", color: "#555", fontSize: "0.9rem" }}
        >
          Catch up on lectures or review complex topics with our recorded
          lessons.
        </p>
