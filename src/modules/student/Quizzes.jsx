...
const Test = () => {
  ...
  if (!selectedSubject) {
    return (
      <div className="test-container">
        <h1 className="test-title">Select a Subject to Test Your Knowledge</h1>
        <div className="subjects-grid">
          {subjects.map(subject => (
            ...
            >
              <div className={`subject-image ${subject.color}`}>
  ...
  <button onClick={handleStartQuiz} className="pavan">
    Start Quiz
  </button>
</div>
            </div>
