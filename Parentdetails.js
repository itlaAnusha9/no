  ...
  return (
    <div style={containerStyle}>
      <div style={headerStyle}>
        <h1 style={titleStyle}>Parent Communication</h1>
        <button 
      ...
      <div style={layoutStyle}>
          ...
          <table style={tableStyle}>
            <thead>
              <tr>
                ...
                <th style={thStyle}>Child Grade</th>
        ...
        <div style={chatContainerStyle}>
          <h3 style={chatTitleStyle}>
            {selectedParent ? `Message ${selectedParent.name}` : 'Select a Parent'}
          </h3>
          <p style={chatSubtitleStyle}>
            {selectedParent && `Regarding ${selectedParent.childName}'s performance (${selectedParent.performance})`}
          </p>
          ...
          {selectedParent && (
            <div style={parentInfoStyle}>
              <div style={infoGridStyle}>
                ...
                <div style={infoItemStyle}>
                  <span style={infoLabelStyle}>Child Grade:</span>
                ...
                <div style={infoItemStyle}>
                  <span style={infoLabelStyle}>Last Contact:</span>
                  <span style={infoValueStyle}>{selectedParent.lastContact}</span>
                </div>
                <div style={infoItemStyle}>
                  <span style={infoLabelStyle}>Performance:</span>
                  <span style={performanceBadgeStyle(selectedParent.performance)}>
                    {selectedParent.performance}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div style={chatMessagesStyle}>
            {currentChatMessages.length === 0 ? (
              <div style={{
                ...
                {selectedParent ? `Start a conversation with ${selectedParent.name} about ${selectedParent.childName}'s ${selectedParent.performance.toLowerCase()} performance` : 'Select a parent to start chatting'}
              </div>
            ) : (
          ...
          <div>
            <textarea
              ...
              placeholder={selectedParent ? `Type your message about ${selectedParent.childName}'s ${selectedParent.performance.toLowerCase()} performance...` : 'Select a parent to start communication'}
              value={message}
