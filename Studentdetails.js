...
const StudentDetails = () => {
  ...
  const students = [
    { id: 1, name: 'John Doe', email: 'john@example.com', status: 'active', grade: 'A', attendance: '95%', lastActive: '2 hours ago' },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', status: 'active', grade: 'A+', attendance: '98%', lastActive: '1 hour ago' },
    { id: 3, name: 'Mike Johnson', email: 'mike@example.com', status: 'inactive', grade: 'C', attendance: '75%', lastActive: '5 days ago' },
    { id: 4, name: 'Sarah Wilson', email: 'sarah@example.com', status: 'active', grade: 'B+', attendance: '92%', lastActive: '30 minutes ago' },
    { id: 5, name: 'Tom Brown', email: 'tom@example.com', status: 'active', grade: 'A-', attendance: '96%', lastActive: '3 hours ago' },
    { id: 6, name: 'Emma Davis', email: 'emma@example.com', status: 'inactive', grade: 'B', attendance: '88%', lastActive: '1 week ago' },
    { id: 7, name: 'Alex Miller', email: 'alex@example.com', status: 'active', grade: 'A', attendance: '97%', lastActive: '15 minutes ago' },
    { id: 8, name: 'Lisa Garcia', email: 'lisa@example.com', status: 'active', grade: 'A+', attendance: '99%', lastActive: '45 minutes ago' },
    { id: 9, name: 'Kevin Martinez', email: 'kevin@example.com', status: 'inactive', grade: 'C+', attendance: '82%', lastActive: '2 weeks ago' },
    { id: 10, name: 'Amy Robinson', email: 'amy@example.com', status: 'active', grade: 'B+', attendance: '94%', lastActive: '1 hour ago' }
  ];
  ...
  const generateStudentResponse = (student) => {
    ...
    const responses = [
      `Thank you for your message, I'll work on improving my skills.`,
      `I appreciate your feedback. I'll focus more on my studies.`,
      `Thanks for reaching out. I'll review the material and get back to you.`,
      `I understand your concerns. I'll put more effort into my assignments.`,
      `Thank you for the guidance. I'll work on the areas you mentioned.`
    ];
    ...
    <div style={containerStyle}>
      ...
      <div style={contentStyle}>
        <div style={headerStyle}>
          <h1 style={titleStyle}>Student Details & Communication</h1>
          <button 
          ...
          <div style={chatContainerStyle}>
            ...
            {selectedStudent && (
              <div style={studentInfoStyle}>
                <div style={infoGridStyle}>
                  ...
                  <div style={infoItemStyle}>
                    <span style={infoLabelStyle}>Grade:</span>
                    <span style={gradeBadgeStyle(selectedStudent.grade)}>
                      {selectedStudent.grade}
                    </span>
                  </div>
                  <div style={infoItemStyle}>
                    <span style={infoLabelStyle}>Attendance:</span>
                    <span style={attendanceBadgeStyle(selectedStudent.attendance)}>
                      {selectedStudent.attendance}
                    </span>
                  </div>
                  <div style={infoItemStyle}>
                    <span style={infoLabelStyle}>Last Active:</span>
            ...
            <div style={chatMessagesStyle}>
              {currentChatMessages.length === 0 ? (
                <div style={{
                  ...
                  {selectedStudent ? `Start a conversation with ${selectedStudent.name}` : 'Select a student to start chatting'}
                </div>
              ) : (
            ...
            <div>
              <textarea
                ...
                placeholder={selectedStudent ? `Type your message to ${selectedStudent.name}...` : 'Select a student to start communication'}
                value={message}
